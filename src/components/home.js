...
const functionDelete = () => {
  ...
  const buttonDelete = taskContainer.querySelectorAll('.bi-trash3');
      ...
      getUserById(dataPost.userId).then((user) => {
        ...
        if (user.data().userId === current.uid) {
          ...
          <div class="containerButton">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" data-id="${doc.id}" viewBox="0 0 16 16">
